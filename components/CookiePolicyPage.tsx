      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none text-grey-300 space-y-6 text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">1. What Are Cookies?</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">2. Types of Cookies We Use</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">3. How You Can Control Cookies</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">4. Third-Party Cookies</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">5. Updates to This Cookie Policy</h2>
            <p>We may update this policy as we add new services or modify the Website.</p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">6. Contact Us</h2>
            <p>For questions, contact: <a href="mailto:mail@nekoyachts.com" className="text-cyan-400 hover:underline">mail@nekoyachts.com</a></p>
