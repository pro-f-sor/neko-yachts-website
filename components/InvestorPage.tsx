  ...
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-grey-950 bg-opacity-80"></div>
      </div>
            ...
            <AnimatedSection className="mt-24">
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <TeamMemberCard 
                        ...
                        bio="An award-winning German architect, William's avant-garde designs push the boundaries of performance and aesthetics. He is the creative force behind the NEKO 19's innovative hull design and spacious layout." 
                    />
                    <TeamMemberCard 
