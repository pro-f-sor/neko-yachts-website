      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none text-grey-300 space-y-6 text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">1. Data We Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">2. How We Use Your Data</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">3. Lawful Basis for Processing</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">4. Data Storage and Security</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">5. Data Sharing</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">6. Your Rights</h2>
            ...
            <ul className="list-disc pl-8">
                ...
                <li>Lodge a complaint with the ICO (<a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">www.ico.org.uk</a>)</li>
            </ul>
            <p>To exercise your rights, contact us at: <a href="mailto:mail@nekoyachts.com" className="text-cyan-400 hover:underline">mail@nekoyachts.com</a></p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">7. Cookies</h2>
            <p>See our full Cookie Policy below.</p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">8. Contact Us</h2>
            <p>
                Cool Catamaran Company<br />
                128 City Road, London, United Kingdom, EC1V 2NX<br />
                Email: <a href="mailto:mail@nekoyachts.com" className="text-cyan-400 hover:underline">mail@nekoyachts.com</a>
            </p>
          </div>
        </AnimatedSection>
      </div>
