      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none text-grey-300 space-y-6 text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">1. Purpose of the Website</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">2. Use of the Website</h2>
            <p>You agree to:</p>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">3. Intellectual Property</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">4. User Submissions</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">5. Third-Party Links</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">6. Website Availability</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">7. Disclaimer of Warranties</h2>
            <p>The Website is provided “as is” without warranties of any kind.</p>
            <p>See full Disclaimer below.</p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">8. Limitation of Liability</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">9. Governing Law</h2>
            <p>These Terms are governed by the laws of England and Wales.</p>
            <p>Any disputes will be resolved in UK courts.</p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">10. Contact</h2>
            <p>For questions about these Terms, email us at: <a href="mailto:mail@nekoyachts.com" className="text-cyan-400 hover:underline">mail@nekoyachts.com</a></p>
          </div>
        </AnimatedSection>
      </div>
    </div>
