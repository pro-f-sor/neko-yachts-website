    ...
    <div className="py-20 sm:py-28">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-8">Disclaimer</h1>
          <div className="prose prose-invert max-w-none text-grey-300 space-y-6 text-lg leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">1. No Professional Advice</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">2. Accuracy of Information</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">3. External Links</h2>
            <p>We are not responsible for the content or reliability of external sites linked from the Website.</p>

            <h2 className="text-2xl font-bold text-cyan-400 pt-4">4. No Liability</h2>
            ...
            <h2 className="text-2xl font-bold text-cyan-400 pt-4">5. Contact</h2>
            <p>For clarification about this Disclaimer, reach us at: <a href="mailto:mail@nekoyachts.com" className="text-cyan-400 hover:underline">mail@nekoyachts.com</a></p>
          </div>
        </AnimatedSection>
      </div>
    </div>
